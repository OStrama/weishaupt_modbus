...
WEBIF_INFO_WAERMEPUMPE: list[WebItem] = [
    WebItem(name="Betrieb", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_betrieb"),
    WebItem(name="Störmeldung", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_stoermeldung"),
    WebItem(name="Warmwassertemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_warmwassertemperatur"),
    WebItem(name="Leistungsanforderung", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_leistungsanforderung"),
    WebItem(name="Solltemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_solltemperatur"),
    WebItem(name="Schaltdifferenz dynamisch", mformat=FORMATS.TEMPERATUR_DELTA, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_schaltdifferenz_dynamisch"),
    WebItem(name="Vorlauftemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_vorlauftemperatur"),
    WebItem(name="Rücklauftemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_ruecklauftemperatur"),
    WebItem(name="Drehzahl Pumpe M1", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_drehzahl_pumpe_m1"),
    WebItem(name="Volumenstrom", mformat=FORMATS.VOLUMENSTROM, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_volumenstrom"),
    ...
    WebItem(name="Soll Leistung", mformat=FORMATS.POWER_KW, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_soll_leistung"),
    WebItem(name="Ist Leistung", mformat=FORMATS.POWER_KW, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_ist_leistung"),
    WebItem(name="Expansionsventil AG Eintr", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_expansionsventil_ag_eintr"),
    WebItem(name="Luftansaugtemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_luftansaugtemperatur"),
    WebItem(name="Wärmetauscher AG Austrit", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_waermetauscher_ag_austritt"),
    WebItem(name="Verdichtersauggastemp.", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_verdichter_ansauggasstemp"),
    WebItem(name="EVI Sauggastemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_evi_sauggastemperatur"),
    WebItem(name="Kältemittel IG Austritt", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_kaeltemittel_ig_austritt"),
    WebItem(name="Ölsumpftemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_oelsumpftemperatur"),
    WebItem(name="Druckgastemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_druckgastemperatur"),
    WebItem(name="Niederdruck", mformat=FORMATS.PRESSURE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_niederdruck"),
    WebItem(name="Verdampfungstemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_verdampfungs_temp"),
    WebItem(name="Hochdruck", mformat=FORMATS.PRESSURE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_hochdruck"),
    WebItem(name="Kondensationstemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_kondensationstemperatur"),
    WebItem(name="Mitteldruck", mformat=FORMATS.PRESSURE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_mitteldruck"),
    WebItem(name="Sättigungstemperatur EVI", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_saettigungstemp_evi"),
    WebItem(name="Überhitzung Heizen", mformat=FORMATS.TEMPERATUR_DELTA, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_ueberhitzung_heizen"),
    WebItem(name="Öffnungsgrad EXV Heizen", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_oeffnungsgrad_exv_heizen"),
    WebItem(name="Überhitzung Verdichter", mformat=FORMATS.TEMPERATUR_DELTA, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_ueberhitzung_verdichter"),
    WebItem(name="Öffnungsgrad EXV Kühlen", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_oeffnungsgrad_exv_kuehlen"),
    WebItem(name="Überhitzung EVI", mformat=FORMATS.TEMPERATUR_DELTA, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_ueberhitzung_evi"),
    WebItem(name="Öffnungsgrad EVI", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_oeffnungsgrad_evi"),
    WebItem(name="Betriebsstd. Verdichter", mformat=FORMATS.TIME_H, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_betriebsstund_verdichter"),
    ...
    WebItem(name="Schaltspiele Abtauen", mformat=FORMATS.ANZAHL, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_schaltspiele_abtauen"),
    WebItem(name="Verdichter", mformat=FORMATS.RPM, mtype=TYPES.SENSOR, device=DEVICES.WIW, webif_group="WIW", translation_key="webif_info_waermepumpe_verdichter"),
...
WEBIF_INFO_2WEZ = [
        WebItem(name="Status", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_status"),
        WebItem(name="Status E-Heizung 1", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_status_eheizung"),
        WebItem(name="Status E-Heizung 2", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_status_eheizung2"),
        WebItem(name="Betriebsstunden E1", mformat=FORMATS.TIME_H, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_betriebsstunden_e1"),
        WebItem(name="Betriebsstunden E2", mformat=FORMATS.TIME_H, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_betriebsstunden_e2"),
        WebItem(name="Schaltspiele E1", mformat=FORMATS.ANZAHL, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_schaltspiele_e1"),
        WebItem(name="Schaltspiele E2", mformat=FORMATS.ANZAHL, mtype=TYPES.SENSOR, device=DEVICES.WI2, webif_group="WI2", translation_key="webif_info_2wez_schaltspiele_e2"),
]

WEBIF_INFO_STATISTIK = [
            WebItem(name="th. Energie Heizen Tag", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_heizen_tag"),
            WebItem(name="th. Energie WW Tag", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_ww_tag"),
            WebItem(name="th. Energie gesamt Tag", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_gesamt_tag"),
            WebItem(name="elektrische Energie Tag", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_elektrische_energie_tag"),
            WebItem(name="th. Energie Heizen Monat", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_heizen_monat"),
            WebItem(name="th. Energie WW Monat", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_ww_monat"),
            WebItem(name="th. Energie gesamt Monat", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_gesamt_monat"),
            WebItem(name="elektrische Energie Monat", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_elektrische_energie_monat"),
            WebItem(name="th. Energie Heizen Jahr", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_heizen_jahr"),
            WebItem(name="th. Energie WW Jahr", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_ww_jahr"),
            WebItem(name="th. Energie gesamt Jahr", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_th_energie_ges_jahr"),
            WebItem(name="elektrische Energie Jahr", mformat=FORMATS.ENERGY, mtype=TYPES.SENSOR, device=DEVICES.WIS, webif_group="WIS", translation_key="webif_info_statistik_elektrische_energie_jahr"),
