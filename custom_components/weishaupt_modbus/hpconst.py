...
WEBIF_INFO_WAERMEPUMPE: list[WebItem] = [
    ...
    WebItem(name="Schaltdifferenz dynamisch", mformat=FORMATS.TEMPERATUR_DELTA, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_schaltdifferenz_dynamisch"),
    ...
    WebItem(name="Ölsumpftemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_oelsumpftemperatur"),
    WebItem(name="Druckgastemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_druckgastemperatur"),
    WebItem(name="Niederdruck", mformat=FORMATS.PRESSURE, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_niederdruck"),
    WebItem(name="Verdampfungstemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_verdampfungs_temp"),
    WebItem(name="Hochdruck", mformat=FORMATS.PRESSURE, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_hochdruck"),
    WebItem(name="Kondensationstemperatur", mformat=FORMATS.TEMPERATUR, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_kondensationstemperatur"),
    ...
    WebItem(name="Öffnungsgrad EVI", mformat=FORMATS.PERCENTAGE, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_oeffnungsgrad_evi"),
    WebItem(name="Betriebsstd. Verdichter", mformat=FORMATS.TIME_H, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_betriebsstund_verdichter"),
    WebItem(name="Schaltspiele Verdichter", mformat=FORMATS.STATUS, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_schaltspiele_verdichter"),
    WebItem(name="Schaltspiele Abtauen", mformat=FORMATS.ANZAHL, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_schaltspiele_abtauen"),
    WebItem(name="Verdichter", mformat=FORMATS.RPM, mtype=TYPES.SENSOR, device=DEVICES.WIH, webif_group="WIW", translation_key="webif_info_waermepumpe_verdichter"),
